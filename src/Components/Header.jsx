...
<div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      ...
      <div >
        ...
        <p className='my-6 text-[15px] text-gray-500'>Remove backgrounds effortlessly and unleash  the full potential<br  className='max-md:hidden'/> of your images with our cutting-edge technology!.</p>
        <div>
            <input type="text" name=""  id='upload1' hidden/>
